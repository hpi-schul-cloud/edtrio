...
import { createDispatch, thunkMiddleware, sentryMiddleware } from "~/utils/dispatch"
...
export function LessonContextProvider({ children}) {
    ...
    const value = { store: state, dispatch: createDispatch(dispatch, state, 'lesson', logger, thunkMiddleware, sentryMiddleware)}
    return (
